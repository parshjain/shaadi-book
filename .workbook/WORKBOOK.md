...
## Recently Completed
- [2026-06-01] Codex-BabyHasan-0601 - Rebranded app/domain for Baby Hasan Bets and added idempotent seed markets
- [2026-05-18] Havana-77364 - Non-technical README path, setup checker, one-command local dev runner
